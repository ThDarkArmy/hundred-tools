export const routesList: any[] = [
    ...
    },
    {
        ...
        path: "/special/emoji/music"
    },
    {
        title: "Heart Emoji",
        imageUrl: "https://assets.piliapp.com/s3pxy/thumbs/emoji/list/thumb-100x75.jpg",
        description: "Click the icon to copy, then paste to anywhere.",
        path: "/special/emoji/heart"
    },
    {
        title: "Bullet Points Emoji",
        imageUrl: "https://assets.piliapp.com/s3pxy/thumbs/emoji/list/thumb-100x75.jpg",
        description: "Click the icon to copy, then paste to anywhere.",
        path: "/special/emoji/bullet-points"
    },
    {
        title: "Sad Emoji",
        imageUrl: "https://assets.piliapp.com/s3pxy/thumbs/emoji/list/thumb-100x75.jpg",
        description: "Click the icon to copy, then paste to anywhere.",
        path: "/special/emoji/sad"
    }
];

export const footerNavComponents: any[] = [
    {
        title: "Home",
        path: "/"
    },
...
export const necessaryNavComponents: any[] =[
    {
